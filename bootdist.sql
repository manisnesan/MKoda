...
--
-- Host: localhost    Database: bootdist
-- ------------------------------------------------------
...
CREATE TABLE `IPTABLE` (
  ...
  `SU_PEER` varchar(100) DEFAULT NULL,
  `SU_PEER_OFFER` varchar(100) DEFAULT NULL,
  `LOAD_FACTOR` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`HOST`)
...
-- Dump completed on 2009-12-17  6:57:02
