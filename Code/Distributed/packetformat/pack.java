...
public class pack{
	...
	public byte header_IP[]=new byte[4];
	public byte port_no[]=new byte[2];
	public byte header_port_no[]=new byte[2];
	public byte reqrep;
	public byte [] data;
	...
	public pack(byte[] packet, int length, InetAddress IP, int port_no ){
		...
		this.TTL=packet[5];
		System.arraycopy(packet,  6, this.header_IP, 0, 4);
		System.arraycopy(packet, 10, this.header_port_no,0,2);
	...
	public InetAddress getHeader_IP() {
		try {
			return InetAddress.getByAddress(this.header_IP);
	...
	public void setHeader_IP(InetAddress headerIP) {
		header_IP = headerIP.getAddress();
	}
	...
	public int getHeader_port_no() {
		return gfns.convBaryInt(header_port_no);
	}

	public void setHeader_port_no(int headerPortNo) {
		header_port_no = gfns.convIntBary_2(headerPortNo);
	}
